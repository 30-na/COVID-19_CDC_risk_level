...
# number of unique community level in two weeks interval
consis_2weeks = c()
...
fig_consis_rate_line01_HM = ggplot(consis_plot_3, aes(x=date, y=consisRate,
    ...
    labs(title="consistancy Rate for each Comunity risk level in 2weeks (High and Medium merged)")
...
fig_consis_rate_line02_HM = ggplot(data = consis_plot_3,
    ...
    labs(title="Consistancy Rate for each Comunity Risk in 2weeks (High and Medium merged)")
...
fig_consis_rate_total_line_HM = ggplot(consis_plot_3_3, aes(x=date,
    ...
    geom_point(alpha = .5)+
    theme_bw()+
    labs(title="total proportion of consistant county in 2weeks (High and Medium merged)")
...
fig_consisRate_box_HM = ggplot(consis_plot_3_3, aes(y=consis_2weeks, x=consisRate))+
...
fig_consis_rate_line01_LM = ggplot(consis_plot_3, aes(x=date, y=consisRate,
    ...
    geom_point(alpha = .5)+
    facet_wrap(~community_level, nrow=3)+
    labs(title="consistancy Rate for each Comunity risk level in 2weeks (Low and Medium merged)")
...
fig_consis_rate_line02_LM = ggplot(data = consis_plot_3,
    ...
    geom_point(alpha = .3)+
    scale_color_manual(values = c("#e34a33", "#2b8cbe", "#fdbb84"))+
    labs(title="Consistancy Rate for each Comunity Risk in 2weeks (Low and Medium merged)")
...
fig_consis_rate_total_line_LM = ggplot(consis_plot_3_3, aes(x=date,
    ...
    geom_hline(yintercept = mean(consis_plot_3_3$consisRate),
               linetype = "dashed")+
    theme_bw()+
    labs(title="total proportion of consistant county in 2weeks (Low and Medium merged)")

#ggsave("Result/consistancy_rate_total.jpg", fig_consis_rate_total_line_LM, height=4,width=8,scale=1.65)


fig_consisRate_box_LM = ggplot(consis_plot_3_3, aes(y=consis_2weeks, x=consisRate))+
...
fig_consis_rate_line01 = ggplot(consis_plot_3, aes(x=date, y=consisRate,
    ...
    geom_point(alpha = .5)+
    facet_wrap(~community_level, nrow=3)+
    labs(title="consistancy Rate for each Comunity risk level in 2weeks")
...
fig_consisRate_box = ggplot(consis_plot_3_3, aes(y=consis_2weeks, x=consisRate))+
